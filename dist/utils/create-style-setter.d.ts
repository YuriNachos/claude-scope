 ...
 */
export declare function createStyleSetter<T>(styleMap: StyleMap<T>, styleFnRef: StyleRef<T>, fallbackStyle?: WidgetStyle): (style?: WidgetStyle) => void;
export {};
//# sourceMappingURL=create-style-setter.d.ts.map