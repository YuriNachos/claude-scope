...
describe('formatCostUSD', () => {
  describe('very small values (< $0.01)', () => {
    it('should format 0 dollars', () => {
      expect(formatCostUSD(0)).to.equal('$0.0000');
    });

    it('should format fractional cents with 4 decimals', () => {
      expect(formatCostUSD(0.00123)).to.equal('$0.0012');
    });

    it('should format just below $0.01', () => {
      expect(formatCostUSD(0.00999)).to.equal('$0.0100');
    });
  });
  ...
  describe('normal values ($0.01 - $100)', () => {
    ...
    it('should format $12.50', () => {
      expect(formatCostUSD(12.50)).to.equal('$12.50');
    });
  ...
  describe('large values (>= $100)', () => {
    it('should format $100', () => {
      expect(formatCostUSD(100)).to.equal('$100');
    });

    it('should format $123.45', () => {
      expect(formatCostUSD(123.45)).to.equal('$123');
    });

    it('should format $1000.99', () => {
      expect(formatCostUSD(1000.99)).to.equal('$1000');
    });
  });
  ...
  describe('edge cases', () => {
    ...
    it('should handle very small values', () => {
      expect(formatCostUSD(0.000001)).to.equal('$0.0000');
    });
  });
});
