...
import type { IWidgetMetadata, RenderContext, WidgetContext } from "../../../src/core/types.js";
import { StdinDataWidget } from "../../../src/widgets/core/stdin-data-widget.js";
...
describe("StdinDataWidget", () => {
  ...
  describe("getData", () => {
    ...
    it("should throw error when data not initialized", () => {
      ...
      expect(() => widget.getData()).to.throw(/Widget test-widget data not initialized/);
    });
